...
public class PlayListOfSpeakerGlassesAndAttacker : MonoBehaviour
{

    public AudioSource speaker;
    public AudioSource attacker;
    public List<AudioClip> attackerClips;
    public List<AudioClip> speakerClips;
    ...
    void Start()
    {
        ...
        //attacker = GetComponent<AudioSource>();
...
// Update is called once per frame
    ...
    IEnumerator PlayWaitTimer()
    {
        ...
        speaker.PlayOneShot(speakerClips[ind],1);
        yield return new WaitForSeconds(speakerClips[ind].length);
        glasses.SetActive(false);
        deltaStarted = true;
